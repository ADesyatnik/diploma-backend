...
class Company(models.Model):
    ...
    business_models = models.ManyToManyField(BusinessModel, related_name="companies", verbose_name=("Бизнес модели"))
    industry_categories = models.ManyToManyField(IndustryCategory, related_name="companies", verbose_name=("Категории промышленности"))
